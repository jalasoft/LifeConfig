...
/**
 * Responsibility of this conversion is provide conversion between
 * primitive types and their boxed equivalents.
 *
 * @author Honza Lastovicka (lastovicka@avast.com)
 * @since 2016-09-19.
 */
public final class PrimitiveAndBoxedTypesConversion implements Conversion {
    ...
    public PrimitiveAndBoxedTypesConversion(Conversion decorated) {
